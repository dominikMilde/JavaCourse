...
public class ArrayIndexedCollection<T> implements List<T>{
	private static class ArrayIndexedElementsGetter<T> implements ElementsGetter<T>{
		...
		public ArrayIndexedElementsGetter(ArrayIndexedCollection<T> array) {
			this.array = array;
			this.index = 0;
...
IllegalArgumentException should be thrown.
	...
	public ArrayIndexedCollection(int initalCapacity) {
		...
		elements = (T[]) new Object[initalCapacity];
	}
...
returns the array. This method never returns null.
	...
	@Override
	public ArrayIndexedElementsGetter<T> createElementsGetter() {
		ArrayIndexedElementsGetter<T> e = new ArrayIndexedElementsGetter<T>(this);
		return e;
	}
