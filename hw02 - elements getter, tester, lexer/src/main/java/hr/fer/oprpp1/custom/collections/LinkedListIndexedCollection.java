...
public class LinkedListIndexedCollection implements List{
	private static class LinkedListIndexedElementsGetter implements ElementsGetter{
		 ...
		 */
		public LinkedListIndexedElementsGetter(LinkedListIndexedCollection list) {
			this.list = list;
...
returns the array. This method never returns null.
	...
	@Override
	public LinkedListIndexedElementsGetter createElementsGetter() {
		LinkedListIndexedElementsGetter e = new LinkedListIndexedElementsGetter(this);
		return e;
